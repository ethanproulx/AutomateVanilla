ServerEvents.recipes(event => {
	...
	event.smithing(
        'create:fluid_tank',                        	 // arg 1: output
        'createmechanisms:rubber_mechanism',             // arg 2: the smithing template
        'create:copper_casing',                          // arg 3: the item to be upgraded
        'minecraft:glass'                                // arg 4: the upgrade item
    )
	event.smithing(
        'create:fluid_pipe',                        	 // arg 1: output
        'createmechanisms:rubber_mechanism',             // arg 2: the smithing template
        'minecraft:copper_ingot',                        // arg 3: the item to be upgraded
        'minecraft:bucket'                               // arg 4: the upgrade item
    )
})